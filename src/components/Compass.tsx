 ...
 * clockwise with the bearing so 90° points east, etc.
 */
export default function Compass({ deg, size = 64 }: { deg: number | null; size?: number }) {
  ...
  return (
    <svg
      ...
      viewBox="0 0 100 100"
      role="img"
      aria-label={deg !== null ? `Wind from ${compass} (${deg}°)` : "No wind direction"}
    >
